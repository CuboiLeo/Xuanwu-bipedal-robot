...
void dm4310_motor_init(void)
{
	...
	motor[Motor5].id = 0x07;
	motor[Motor5].ctrl.mode = 0;		// 0: MIT模式   1: 位置速度模式   2: 速度模式
	motor[Motor5].ctrl.vel_set = 1.0f;
	motor[Motor5].ctrl.kd_set = 1.0f;
	
	motor[Motor6].id = 0x08;
	motor[Motor6].ctrl.mode = 0;		// 0: MIT模式   1: 位置速度模式   2: 速度模式
	motor[Motor6].ctrl.vel_set = 1.0f;
	motor[Motor6].ctrl.kd_set = 1.0f;
}
...
//	switch (rec_id)
//	{
// 		case 0x15: dm4310_fbdata(&motor[Motor1], rx_data); break;
//		case 0x16: dm4310_fbdata(&motor[Motor2], rx_data); break;
//		case 0x17: dm4310_fbdata(&motor[Motor3], rx_data); break;
//		case 0x18: dm4310_fbdata(&motor[Motor4], rx_data); break;
//	}
//}
