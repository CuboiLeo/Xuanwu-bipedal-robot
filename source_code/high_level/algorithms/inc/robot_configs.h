...
static constexpr float ROBOT_HEIGHT = L2 + L4 + L5 + L6; // Height of the robot from the ground to the center of center control module
...
static constexpr float M5 = 0.53f;  // Knee pitch connector + ankle pitch motor
static constexpr float M6 = 0.14f;  // Foot connector
