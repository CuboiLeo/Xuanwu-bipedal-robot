...
val_L5 = 0.18;
val_L6 = 0.075;
sub_vals = [val_theta1 val_theta2 val_theta3 val_theta4 val_theta5 val_theta6 val_theta7 val_theta8 val_theta9 val_theta10 val_L1 val_L2 val_L3 val_L4 val_L5 val_L6];
sub_syms = [theta1 theta2 theta3 theta4 theta5 theta6 theta7 theta8 theta9 theta10 L1 L2 L3 L4 L5 L6];

val_T_left = vpa(subs(T_left,sub_syms,sub_vals),2);
val_T_right = vpa(subs(T_right,sub_syms,sub_vals),2);
left_foot_pitch = vpa(rad2deg(atan2(val_T_left(3,2),val_T_left(3,3))),3);
right_foot_pitch = vpa(rad2deg(atan2(val_T_right(3,2),val_T_right(3,3))),3);
